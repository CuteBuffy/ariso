  ...
  return (
    <>
      <section className="main__section__1">
        ...
        <img className="main__section__1__circle" src="../../../public/imgs/main-circle.png" alt="circle image" />
      ...
      <section className="main__section__2">
        ...
        <div className="main__section__2__showcase__container">
          <div className="main__section__2__item">
            <img src="../../../public/imgs/range1.png" alt="best skin days" />
          ...
          <div className="main__section__2__item">
            <img src="../../../public/imgs/range2.png" alt="best skin days" />
            <div className="main__section__2__item__info">
              <h3 className="main__section__2__item__title">
                MARBLE CREAMS
              </h3>
          ...
          <div className="main__section__2__item">
            <img src="../../../public/imgs/range3.png" alt="best skin days" />
            <div className="main__section__2__item__info">
              <h3 className="main__section__2__item__title">
                FARMENT CREAM
              </h3>
          ...
          <div className="main__section__2__item">
            <img src="../../../public/imgs/range4.png" alt="best skin days" />
            <div className="main__section__2__item__info">
              <h3 className="main__section__2__item__title">
                TOBACCO VANILLA
              </h3>
          ...
          <div className="section__1">
            <div className="relative section__1__top">
              ...
              <button className="main__black__arrow">
                <img src="../../../public/icons/arrow-black.png" alt="white arrow" />
              </button>
              <img src="../../../public/imgs/select1.png" alt="Skin care" />
            </div>
            <div className="relative section__1__bottom">
              <p className="showcase__desc">Blog/Articles</p>
              <img src="../../../public/imgs/select2.png" alt="Blog/Articles" />
            </div>
          </div>
          <div className="relative section__middle">
            <p className="showcase__desc">Reviews</p>
            <button className="main__black__arrow">
              <img src="../../../public/icons/arrow-black.png" alt="black arrow" />
            </button>
            <img src="../../../public/imgs/select3.png" alt="Reviews" />
          </div>
            ...
            <div className="section__2-2">
              ...
              <div className="relative section__3__showcase__more">
                ...
                <button className="arrow__white">
                  <img src="../../../public/icons/arrow-white.png" alt="white arrow" />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="advantages__container">
            <div className="advantage">
              <span className="advantage__icon">
                <img src="../../../public/icons/advantage1.png" alt="Advantage 1" />
              </span>
            ...
            <div className="advantage">
              <span className="advantage__icon">
                <img src="../../../public/icons/advantage2.png" alt="Advantage 1" />
              </span>
            ...
            <div className="advantage">
              <span className="advantage__icon">
                <img src="../../../public/icons/advantage3.png" alt="Advantage 1" />
              </span>
      ...
      <section className="lowermargin main__section__5">
        <div className="relative main__section__5__container">
          <img src="../../../public/imgs/footer-img.png" alt="Notifications Question Image" />
